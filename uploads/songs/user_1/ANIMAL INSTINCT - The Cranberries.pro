...
{t: ANIMAL INSTINCT – The Cranberries  }
{st: (O’Riordan/Hogan)  }
{artist: The Cranberries  }
{composer: Dolores O’Riordan; Hogan  }


https://www.youtube.com/watch?v=ky4CdN0x58A  (Capo 0)

TIP:  It the first part of the first and second lines of the verse, the melody descends and then climbs.  For example, in the first line you begin the descent on (Am7), bottom out on “happened” and then climbing to the (C) on “me.”  So the first note and the last note are both <e>.  If you don’t sing it this way the (C) will sound off.  

TIP:  Dolores drags the syllable on “reality” and “away” in the second verse so hold the (D) through the word and move to the (Em) at the very last moment.
...
It is the [D]lovely thing that we [Em]have.   It is the [D]lovely thing that we-[G]ee.
